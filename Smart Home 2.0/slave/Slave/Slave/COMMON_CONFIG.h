...
#define HOUSE_PORT DDRC
#define HOUSE_POWER 0x1F

#define LOGOUT_SLAVE '7'
#define LOGOUT_FROM_HOUSE 0xFF

#define SENSOR_PORT DDRA
#define SENSOR_READ 0x00
#define TEMP_SENSOR_FACTOR 4
...
typedef struct option {
	...
	char AirCond_State ;
	volatile char AirCondDegree ;
	
	volatile unsigned char ADC_read ;
}	Option;
